  ...
  return (
    <section className="section-container py-20 md:py-32">
      <motion.div
        ...
        className="max-w-4xl"
      >
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-medium mb-6 gradient-text">
          {personalInfo.name}
        </h1>
        ...
        <p className="text-lg md:text-xl text-text-muted max-w-3xl mb-8 leading-relaxed">
